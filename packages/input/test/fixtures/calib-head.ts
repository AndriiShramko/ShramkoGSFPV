// Frozen copy of the wizard that hung on Andrii's radio on 2026-09-25 (git show ce4b8d2:packages/input/src/calib.ts); negative control only, never used by the app.
